...
output "bigquery_native_table_id" {
  description = "The ID of the BigQuery native table for storing the event data."
  value       = google_bigquery_table.json_native_table.table_id
}
